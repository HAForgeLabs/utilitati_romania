const UTILITATI_ROMANIA_FRONTEND_VERSION = "1.10.13b1";
...
class UtilitatiRomaniaFacturiCard extends HTMLElement {
  ...
  _daysPastDue(value) {
    ...
    const diffMs = this._todayDate().getTime() - date.getTime();
  ...
  _deriveControlsFromReadingSensor(location, provider, readingSensor) {
    ...
    if (providerKey === "apa_canal" || providerKey === "apa_brasov" || providerKey === "apa_oradea" || providerKey === "aparegio" || providerKey === "polaris" || providerKey === "hidro_prahova") {
      ...
      button.addEventListener("click", async (event) => {
        ...
        try {
          ...
          if (providerKey === "apa_canal" || providerKey === "apa_brasov" || providerKey === "apa_oradea" || providerKey === "aparegio" || providerKey === "polaris" || providerKey === "hidro_prahova") {
            ...
            if (providerKey === "eon") {
              const wrongProviderPattern = /(hidro|hidroelectrica|myelectrica|apa_canal|apa_brasov|apa_oradea|aparegio|polaris|hidro_prahova|apacanal|ebloc)/i;
